    ...
    int addr)
{
    ...
    {
        binary = (0x04 << 2) + 0x03;                                 // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);                  // rd
        binary += (reg_to_num(arg2, line_no) << 15);                 // rs1
        binary += (MASK11_0(validate_imm(arg3, 12, line_no)) << 20); // imm[11:0]
    }
    else if (is_opcode(opcode) == SLLI)
    {
        /* Lab2-1 assignment */
        binary = (0x1 << 12) + (0x04 << 2) + 0x03;   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);  // rd
        binary += (reg_to_num(arg2, line_no) << 15); // rs1
        binary += (lower5bit(arg3, line_no) << 20);  // imm[11:0]
    }
    else if (is_opcode(opcode) == XORI)
    {
        /* Lab2-1 assignment */
        binary = (0x4 << 12) + (0x04 << 2) + 0x03;                   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);                  // rd
        binary += (reg_to_num(arg2, line_no) << 15);                 // rs1
        binary += (MASK11_0(validate_imm(arg3, 12, line_no)) << 20); // imm[11:0]
    }
    else if (is_opcode(opcode) == SRLI)
    {
         ...
         */
        binary = (0x5 << 12) + (0x04 << 2) + 0x03;   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);  // rd
        binary += (reg_to_num(arg2, line_no) << 15); // rs1
        binary += (lower5bit(arg3, line_no) << 20);  // imm[11:0]
    }
    else if (is_opcode(opcode) == SRAI)
    {
         ...
         * tip: you may need the function `lower5bit`
         */
        binary = (0x20 << 25) + (0x5 << 12) + (0x04 << 2) + 0x03; // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);               // rd
        binary += (reg_to_num(arg2, line_no) << 15);              // rs1
        binary += (lower5bit(arg3, line_no) << 20);               // imm[11:0]
    }
    ...
    {
        /* Lab2-1 assignment */
        binary = (0x6 << 12) + (0x04 << 2) + 0x03;                   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);                  // rd
        binary += (reg_to_num(arg2, line_no) << 15);                 // rs1
        binary += (MASK11_0(validate_imm(arg3, 12, line_no)) << 20); // imm[11:0]
    }
    ...
    {
        /* Lab2-1 assignment */
        binary = (0x7 << 12) + (0x04 << 2) + 0x03;                   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);                  // rd
        binary += (reg_to_num(arg2, line_no) << 15);                 // rs1
        binary += (MASK11_0(validate_imm(arg3, 12, line_no)) << 20); // imm[11:0]
    }
    ...
    {
        binary = (0x0C << 2) + 0x03;                 // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);  // rd
        binary += (reg_to_num(arg2, line_no) << 15); // rs1
    ...
    {
        /* Lab2-1 assignment */
        binary = (0x1 << 12) + (0x0C << 2) + 0x03;   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);  // rd
        binary += (reg_to_num(arg2, line_no) << 15); // rs1
        binary += (reg_to_num(arg3, line_no) << 20); // rs2
    ...
    {
        /* Lab2-1 assignment */
        binary = (0x4 << 12) + (0x0C << 2) + 0x03;   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);  // rd
        binary += (reg_to_num(arg2, line_no) << 15); // rs1
        binary += (reg_to_num(arg3, line_no) << 20); // rs2
        binary += (0x00 << 25);                      // funct7
    ...
    {
        /* Lab2-1 assignment */
        binary = (0x5 << 12) + (0x0C << 2) + 0x03;   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);  // rd
        binary += (reg_to_num(arg2, line_no) << 15); // rs1
        binary += (reg_to_num(arg3, line_no) << 20); // rs2
        binary += (0x00 << 25);                      // funct7
    ...
    {
        /* Lab2-1 assignment */
        binary = (0x6 << 12) + (0x0C << 2) + 0x03;   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);  // rd
        binary += (reg_to_num(arg2, line_no) << 15); // rs1
        binary += (reg_to_num(arg3, line_no) << 20); // rs2
        binary += (0x00 << 25);                      // funct7
    ...
    {
        /* Lab2-1 assignment */
        binary = (0x7 << 12) + (0x0C << 2) + 0x03;   // funct3 + opcode
        binary += (reg_to_num(arg1, line_no) << 7);  // rd
        binary += (reg_to_num(arg2, line_no) << 15); // rs1
        binary += (reg_to_num(arg3, line_no) << 20); // rs2
        binary += (0x00 << 25);                      // funct7
